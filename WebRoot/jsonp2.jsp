...
<script type="text/javascript">
	...
	$(function() {
		$("#sendRequest").click(function() {
			var flickerAPI = "http://localhost:8080/personalKnowledgeMgr/JsonpServlet?jsoncallback=?";
			...
			$.getJSON( flickerAPI, {
			    ...
			    //$("#showcontent").html("");
			      $.each( data.items, function( i, item ) {
			        $( "<input>" ).attr( "value", item.inputValue).appendTo("#showcontent");
			        $("#showcontent").append("<input type='button' value='点我一个试试' /><br>");
			      });
			    })
