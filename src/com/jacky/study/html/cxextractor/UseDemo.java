...
public class UseDemo {
	...
	public static void main(String[] args) throws IOException {
		...
		String url = "http://news.sina.com.cn/c/2014-08-25/172030740468.shtml";
		url = "http://blog.sina.com.cn/s/blog_4cbec5e90100dgyy.html";

		/* 注意：本处只为展示抽取效果，不处理网页编码问题，getHTML只能接收GBK编码的网页，否则会出现乱码 */
//		String content = new UseDemo().getHTML(args[0]);
		String content = new UseDemo().getHTML(url);
